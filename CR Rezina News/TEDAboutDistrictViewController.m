//
//  TEDAboutDistrictViewController.m
//  CR Rezina
//
...
@interface TEDAboutDistrictViewController ()

@end

@implementation TEDAboutDistrictViewController
...
- (void)viewDidLoad
{
    ...
    NSString* plistPath = [[NSBundle mainBundle] pathForResource: @"aboutDistrict"
                                                          ofType: @"plist"];
